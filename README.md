...
Install the dataset (from https://www.nature.com/articles/s41597-024-02943-8) and put it in a folder on your computer. In order to extact data in Excel sheets, you can use the code 1_data_extraction. 
