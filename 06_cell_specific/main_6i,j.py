...
filtered_clustering = df_clustering[df_clustering['Cell_Type_New'].isin(['IN'])] #Or change to PY for PY neurons 
...
save_path = os.path.join(folder_path, "decoding_timebins_in.eps")
