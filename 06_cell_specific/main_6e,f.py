...
df_neuron_locations = pd.read_excel('/Users/darikussovska/Desktop/PROJECT/Clustering_3D.xlsx')
...
df_neuron_locations['Region_Label'] = df_neuron_locations['Cell_Type_New'].replace({
     'PY': 'PY', 
     'IN': 'IN'
})
