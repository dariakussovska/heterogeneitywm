...
# STEP 2: Add Category to encoding files
print("\n" + "="*50)
...
# Add Category to encoding files
enc1_data = add_category_to_encoding(enc1_data, "Encoding1")
enc2_data = add_category_to_encoding(enc2_data, "Encoding2") 
enc3_data = add_category_to_encoding(enc3_data, "Encoding3")

# Save the updated encoding files
...
print("Encoding files updated with Category")
...
# STEP 5: Process Delay and Probe files
print("\n" + "="*50)
...
if os.path.exists(delay_clean_path):
    ...
    delay_graph = add_category_from_encoding(delay_graph, enc1_data, enc2_data, enc3_data, "Delay (graph)")
...
if os.path.exists(probe_clean_path):
    ...
    probe_graph = add_category_from_encoding(probe_graph, enc1_data, enc2_data, enc3_data, "Probe (graph)")
