...
# =========================
# 2) Location -> Region (collapse _left/_right)
# =========================
def collapse_lr(loc):
    if pd.isna(loc):
        return np.nan
...
# =========================
# 4) Subject inclusion threshold per region
# =========================
MIN_NEURONS_PER_REGION = 4 # change if you want
...
# =========================
# 6) Main loop: region-based bursting
#
# IMPORTANT: normalization by neuron count is applied to avoid fake region differences
...
# =========================
# 7) Plotting + within-region period stats (Wilcoxon + FDR)
# =========================
...
for load in [1, 2, 3]:
    ...
    plt.savefig(f"/Users/darikussovska/Desktop/PROJECT/Figures/Bursting/region_burst_load{load}.eps",
                format='eps', dpi=300)
    plt.show()


# =========================
# 8) Summary stats + p-value table per region
# =========================
...
out_stats_xlsx = "/Users/darikussovska/Desktop/PROJECT/Region_Burst_Summary_and_Pvalues.xlsx"
...
out_xlsx = "/Users/darikussovska/Desktop/PROJECT/Region_Burst_Counts_All.xlsx"
