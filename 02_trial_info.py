...
if not all_metrics.empty:
    ...
    all_metrics.to_excel('./all_spike_rate_metrics.xlsx')
...
all_data_enc1 = pd.read_xlsx(f'./all_spike_rate_data_encoding1.xlsx')
all_data_enc2 = pd.read_xlsx(f'./all_spike_rate_data_encoding2.xlsx')
all_data_enc3 = pd.read_xlsx(f'./all_spike_rate_data_encoding3.xlsx')

trial_info_df = create_trial_info_df(all_data_enc1, all_data_enc2, all_data_enc3)
output_path = './trial_info.xlsx'
trial_info_df.to_excel(output_path)
